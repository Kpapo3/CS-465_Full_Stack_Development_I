export const trips = [
    {
        ...
        "perPerson" : "799.00",
        "image" : "reef1.jpg",
        "description" : "<p>Gale Reef But and augue lorem. In sit amet placerat arcu. Mauris volutpat ipsum ac justo mollis vel vestibulum orci gravida. Vestibulum sit amet porttitor odio. Nulla facilisi. Fusce at pretium felis. But the result is free as ugly as venenatis as some laughter always. Even my convallis or laughter price of the companions. Even now lorem ullamcorper life laoreet.</p>"
    }, 
    {
        "code" : "DAWR210315",
        "name" : "Dawson's Reef",
